                ...
                <div className='movie-small-card-name-date-rating-btns-container'>
                    {
                        ...
                        <Link to={`/movieDtails/${props.mediaType}/${props.movieId}/season/${props.seasonNum}`} style={{ color: 'white', textDecoration: 'none' }}>
                    ...
                    <Link to={`/movieDtails/${props.mediaType}/${props.movieId}/season/${props.seasonNum}/episode/${props.episodeNumber}`} style={{ color: 'white', textDecoration: 'none' }}>
                    <div className='movie-small-card-name-date-rating'>
                    ...
                    <div className='movie-small-card-btns'>
                        ...
                        <a className='movie-small-card-btn-add'><AddIcon style={{ fontSize: '1.3vw' }}/></a>
                    </div>
                </div>
            </div>
        </div>
